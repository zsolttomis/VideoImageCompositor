...
typedef int (NVTX_API * nvtxInitialize_impl_fntype)(const nvtxInitializationAttributes_t* initAttrib);
extern nvtxInitialize_impl_fntype NVTX_VERSIONED_IDENTIFIER(nvtxInitialize_impl_fnptr);
NVTX_DECLSPEC int NVTX_API nvtxInitialize(const nvtxInitializationAttributes_t* initAttrib)
{
    return NVTX_VERSIONED_IDENTIFIER(nvtxInitialize_impl_fnptr)(initAttrib);
}

#include "inl/nvToolsExtCORE_impl.h"
#include "inl/nvToolsExtCORE2_impl.h"
#endif /*NVTX_NO_IMPL*/
